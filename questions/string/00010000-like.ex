...
<p>One point that's worth considering when you use <c>LIKE</c> is how it uses indexes.  If you're using the 'C' <a href="http://www.postgresql.org/docs/9.2/static/locale.html">locale</a>, any <c>LIKE</c> string with a fixed beginning (as in our example here) can use an index.  If you're using any other locale, <c>LIKE</c> will not use any index by default.  See <a href="http://www.postgresql.org/docs/9.2/static/indexes-opclass.html">here</a> for details on how to change that.</p>
|HINT|
