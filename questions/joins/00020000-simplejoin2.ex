...
|QUESTION|
How can you produce a list of the start times for bookings for tennis courts (facility IDs 0 or 1), for the date '2012-09-21'?  Return a list of start time and facility name pairings, ordered by the time.
|QUERY|
